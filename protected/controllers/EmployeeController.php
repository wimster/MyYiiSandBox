...
class EmployeeController extends CController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Employee']))
		{
                       ...
                       if (!empty($model->departmentId)) $criteria->addCondition('departmentId = "'.$model->departmentId.'"');
                       ...
                       if (!empty($model->ext)) $criteria->addCondition('ext = "'.$model->ext.'"');


                       if (!empty($model->hireDate)) $criteria->addCondition('hireDate = "'.$model->hireDate.'"');


                       if (!empty($model->leaveDate)) $criteria->addCondition('leaveDate = "'.$model->leaveDate.'"');

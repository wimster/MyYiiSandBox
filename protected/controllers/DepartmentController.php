...
class DepartmentController extends CController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Department']))
		{
                 ...
                 $session['Department_records']=Department::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Department_records']))
               {
                $model=$session['Department_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetSubject('Department Report');
		...
		$pdf->LastPage();
		$pdf->Output("Department_002.pdf", "I");
	}
}
